...
const closeNoteBtn = noteModal
  ? noteModal.querySelector(".close-button")
  : null;
const closeCodeBtn = codeModal
  ? codeModal.querySelector(".close-button")
  : null;
...
if (okCodeBtn)
  okCodeBtn.addEventListener("click", () => {
